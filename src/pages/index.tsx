...
import iconCheckedImg from '../assets/icon-check.svg';
    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        ...
        <form onSubmit={createPool} className='mt-10 flex gap-2'>
          <input
            className='flex-1 px-6 py-6 rounded bg-gray-800 border-gray-600 text-sm text-gray-100'
            type="text"
            required
          ...
          />
          <button
            className='px-6 py-6 rounded bg-yellow-500 text-gray-900 font-bold text-sm uppercase hover:bg-yellow-700'
            type='submit'
          >
            Criar meu bolão
          </button>
